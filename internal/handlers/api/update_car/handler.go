...
func (h *Handler) Handle(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		logger.Warn("PATCH /users/me/cars/{car_id} - Unauthorized access attempt")
	...
	if carIDStr == "" {
		logger.Warn("PATCH /users/me/cars/{car_id} - Car ID missing: user_id=%d", userID)
	...
	if err != nil {
		logger.Warn("PATCH /users/me/cars/{car_id} - Invalid car ID format: user_id=%d, car_id_str=%s", userID, carIDStr)
	...
	if err = api.DecodeJSON(r, &input); err != nil {
		logger.Warn("PATCH /users/me/cars/{car_id} - Invalid request body: user_id=%d, car_id=%d, error=%v", userID, carID, err)
	...
	if err != nil {
		...
		logger.Error("PATCH /users/me/cars/{car_id} - Failed to update car: user_id=%d, car_id=%d, error=%v", userID, carID, err)
